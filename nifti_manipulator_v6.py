# -*- coding: utf-8 -*-
"""
Created on Mon Mar 19 18:53:32 2012
...
def main():
    ...
    outPath = sys.argv[2]
    sysPath = '/home2/surchs/scripts'
    configFile = 'configFile.txt'

    conf = open(os.path.join(sysPath, configFile)).readline().strip().split()
    (mPath, mname, funcAbsPath, funcRelPath, funcName) = conf
    ...
    TexSaver(resultList, (outPath), prefix='reslist', suffix='newall')
    ...
    TexSaver(feature, (outPath), prefix='feature', suffix='newall')
    TexSaver(ages, (sysPath + '/output'), prefix='ages', suffix='all')
